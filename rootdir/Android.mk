...
include $(CLEAR_VARS)
LOCAL_MODULE        := android.hardware.camera.provider@2.4-external-service.rc
LOCAL_MODULE_TAGS   := optional
LOCAL_MODULE_CLASS  := ETC
LOCAL_SRC_FILES     := etc/android.hardware.camera.provider@2.4-external-service.rc
...
LOCAL_MODULE_TAGS   := optional
LOCAL_MODULE_CLASS  := ETC
LOCAL_SRC_FILES     := etc/android.hardware.camera.provider@2.4-service.rc
LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_ETC)/init
include $(BUILD_PREBUILT)
