...
#define LOG_TAG "android.hardware.light@2.0-service.g4"
...
const static std::string kRedLedTimerPath= "/sys/class/leds/red/ramp_step_ms";
const static std::string kGreenLedTimerPath = "/sys/class/leds/green/ramp_step_ms";
const static std::string kBlueLedTimerPath = "/sys/class/leds/blue/ramp_step_ms";
const static std::string kRgbLockPath = "/sys/class/leds/red/start_idx";

int main() {
    printf("asdf\n");
    ALOGV("G4 Lights Hal Starting up!");
