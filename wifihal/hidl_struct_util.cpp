...
NanStatusType convertLegacyNanStatusTypeToHidl(legacy_hal::NanStatusType type) {
    switch (type) {
        ...
        case legacy_hal::NAN_STATUS_INVALID_PAIRING_ID:
            return NanStatusType::INVALID_PAIRING_ID;
        case legacy_hal::NAN_STATUS_INVALID_BOOTSTRAPPING_ID:
            return NanStatusType::INVALID_BOOTSTRAPPING_ID;
        case legacy_hal::NAN_STATUS_REDUNDANT_REQUEST:
            return NanStatusType::REDUNDANT_REQUEST;
    }
    CHECK(false);
}
...
legacy_hal::wifi_rtt_type convertHidlRttTypeToLegacy(RttType type) {
    switch (type) {
        ...
        case RTTType::RTT_TYPE_2_SIDED_11AZ_NTB:
            return legacy_hal::RTT_TYPE_2_SIDED_11AZ_NTB;
        case RTTType::RTT_TYPE_2_SIDED_11AZ_NTB_SECURE:
...
legacy_hal::wifi_channel_width convertHidlWifiChannelWidthToLegacy(
    ...
    switch (type) {
        ...
        case WifiChannelWidthInMhz::WIFI_CHAN_WIDTH_320:
...
legacy_hal::wifi_rtt_preamble convertHidlRttPreambleToLegacy(RttPreamble type) {
    switch (type) {
        ...
        case RttPreamble:WIFI_RTT_PREAMBLE_INVALID:
            return legacy_hal::WIFI_RTT_PREAMBLE_INVALID;
        case RttPreamble::WIFI_RTT_PREAMBLE_EHT:
...
legacy_hal::wifi_rtt_bw convertHidlRttBwToLegacy(RttBw type) {
    switch (type) {
        ...
        case RTTBw:WIFI_RTT_BW_UNSPECIFIED:
            return legacy_hal::WIFI_RTT_BW_UNSPECIFIED;
        case RttBw::WIFI_RTT_BW_320:
